...
var PulsechainTestnet = c940;
var PulsechainTestnetV2b = c941;
...
function getChainByChainId(chainId) {
  const chain = allChains.find((chain2) => chain2.chainId === chainId);
  if (!chain) {
...
function getChainBySlug(slug) {
  const chain = allChains.find((chain2) => chain2.slug === slug);
  if (!chain) {
